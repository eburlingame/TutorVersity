package com.example.eric.tutorversity.models.api;
...
public class URLConstants {
    ...
    public static final String LOGOUT_URL = URL_BASE + "logout";
    public static final String GET_QUESTIONS_URL = URL_BASE + "getQuestions";
    public static final String GET_USER_QUESTIONS_URL = URL_BASE + "getUserQuestions";
